...
class TopicsService {
     ...
     * @throws ApiError
     */
    static getTopicsServiceRcmsApi1Feeds(requestParam) {
     ...
     * @throws ApiError
     */
    static postTopicsServiceRcmsApi1FeedCreate(requestParam) {
        return __awaiter(this, void 0, void 0, function* () {
            const shouldHookToken = Object.keys({
                'Token-Auth': OpenAPI_1.OpenAPI.SECURITY['Token-Auth'],
            }).length > 0;
     ...
     * @throws ApiError
     */
    static postTopicsServiceRcmsApi1FeedDeleteTopicsId(requestParam) {
        return __awaiter(this, void 0, void 0, function* () {
            const shouldHookToken = Object.keys({
                'Token-Auth': OpenAPI_1.OpenAPI.SECURITY['Token-Auth'],
            }).length > 0;
     ...
     * @throws ApiError
     */
    static postTopicsServiceRcmsApi1FeedUpdateTopicsId(requestParam) {
        return __awaiter(this, void 0, void 0, function* () {
            const shouldHookToken = Object.keys({
                'Token-Auth': OpenAPI_1.OpenAPI.SECURITY['Token-Auth'],
            }).length > 0;
     ...
     * @throws ApiError
     */
    static getTopicsServiceRcmsApi1Tg(requestParam) {
        return __awaiter(this, void 0, void 0, function* () {
            const shouldHookToken = Object.keys({
                'Token-Auth': OpenAPI_1.OpenAPI.SECURITY['Token-Auth'],
            }).length > 0;
     ...
     * @throws ApiError
     */
    static getTopicsServiceRcmsApi1FeedGroup(requestParam) {
        return __awaiter(this, void 0, void 0, function* () {
            const shouldHookToken = Object.keys({
                'Token-Auth': OpenAPI_1.OpenAPI.SECURITY['Token-Auth'],
            }).length > 0;
     ...
     * @throws ApiError
     */
    static getTopicsServiceRcmsApi1Infos(requestParam) {
        return __awaiter(this, void 0, void 0, function* () {
            const shouldHookToken = Object.keys({
                'Token-Auth': OpenAPI_1.OpenAPI.SECURITY['Token-Auth'],
            }).length > 0;
     ...
     * @throws ApiError
     */
    static getTopicsServiceRcmsApi1PreInfo(requestParam) {
        return __awaiter(this, void 0, void 0, function* () {
            const shouldHookToken = Object.keys({
                'Token-Auth': OpenAPI_1.OpenAPI.SECURITY['Token-Auth'],
            }).length > 0;
